...
import com.o2.techm.netcool.eai.o2gateway.netcool.SendSMS;
 ...
 * @author trenaman
 */
public class SendSMSPlugin implements Plugin
{

	private static final Logger log = LoggerFactory.getLogger(SendSMSPlugin.class);
    ...
    public void postInit(PluginManager mgr) throws PluginException
    {
        ...
        SMSBrokerPlugin smsPlugin = (SMSBrokerPlugin) mgr.getPlugins().get(SMSBrokerPlugin.NAME);
        ...
        SendSMS sendSMSTroubleTicketHandler = new SendSMS(smsPlugin, netcoolPlugin,
                cicDateFormat, dummyStringColumnName, dummyStringValue,
                dummyIntegerColumnName, dummyIntegerValue);
        
        log.info("Adding SendSMS handler to Netcool Listener");
        netcoolPlugin.getNetcoolListener().addHandler(sendSMSTroubleTicketHandler);        
    }
    ...
    /* (non-Javadoc)
     * @see com.o2.osiris.pluginframework.Plugin#getName()
     */
